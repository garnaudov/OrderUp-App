...
function confirmHealthyOption(){
swal({
  title: 'Потвърждавате ли добавянето на здравословното предложение?',
  type: 'question',
  showCancelButton: true,
  confirmButtonColor: '#3085d6',
  cancelButtonColor: '#d33',
  confirmButtonText: 'Да, добавям',
    cancelButtonText: 'Не, отказвам',
  confirmButtonClass: 'btn text-success',
  cancelButtonClass: 'btn text-danger',
  buttonsStyling: false
  
}).then(function () {
  swal(
    'Добавено към поръчката успешно!',
    'Благодарим Ви!',
    'success'
  )
}, function (dismiss) {
...
function confirmQ(){
    swal({
  title: 'Сигурни ли сте, че искате да го добавите към поръчката?',
  type: 'question',
  showCancelButton: true,
  confirmButtonColor: '#3085d6',
  cancelButtonColor: '#d33',
  confirmButtonText: 'Да, добави',
    cancelButtonText: 'Не, отказвам',
  confirmButtonClass: 'btn text-success',
  cancelButtonClass: 'btn text-danger',
  buttonsStyling: false
...
function confirmOrder(){
    swal({
  title: 'Потвърждавате ли изпращането на поръчката?',
  type: 'question',
  showCancelButton: true,
  confirmButtonColor: '#3085d6',
  cancelButtonColor: '#d33',
...
function checkout(){
    swal({
  title: 'Сигурни ли сте, че искате да повикате за сметката?',
  type: 'question',
  showCancelButton: true,
  confirmButtonColor: '#3085d6',
  cancelButtonColor: '#d33',
  confirmButtonText: 'Да, желая да платя',
    cancelButtonText: 'Не, отказвам',
  confirmButtonClass: 'btn text-success',
  cancelButtonClass: 'btn text-danger',
  buttonsStyling: false
  ...
  swal(
    'Сервитьорът ще ви донесе сметката всеки момент!',
    'Благодарим Ви!',
    'success'
  )
}, function (dismiss) {
  ...
  if (dismiss === 'cancel') {
    swal(
      'Сметката няма да бъде повикана!',
